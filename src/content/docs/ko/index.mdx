...
hero:
  ...
  actions:
    - text: Get started
      link: /ko/learn/get-started/
      icon: right-arrow
      variant: primary
    - text: Documentation
      link: /ko/documentation/master
      icon: external
---
...
<IndexUrl>
    <a href="learn/overview/" class="button" style="color:var(--sl-color-white);text-decoration:none;font-weight: 600;font-size: var(--sl-text-lg);">자세히 알아보기</a>
</IndexUrl>


<IndexUrl>
    <a href="learn/samples/" class="button" style="color:var(--sl-color-white);text-decoration:none;font-weight: 600;font-size: var(--sl-text-lg);">코드 예제 더 보기</a>
</IndexUrl>
...
<IndexUrl>
	<a href="https://github.com/ziglang/zig/wiki/Community" class="button" style="color:var(--sl-color-white);text-decoration:none;font-weight: 600;font-size: var(--sl-text-lg);">모든 커뮤니티 보기</a>
</IndexUrl>
...
<IndexUrl>
	<a href="zsf/" class="button" style="color:var(--sl-color-white);text-decoration:none;font-weight: 600;font-size: var(--sl-text-lg);">자세히 알아보기</a>
</IndexUrl>
