---
title: Building Zig from source on Windows
description: Instructions for building Zig from source on Windows
---

**Note**: If you want the latest build of Zig on Windows, you can get it from [the download page](/download/).
